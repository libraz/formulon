...
**Mac Excel 365 in ja-JP locale**. Several Excel function families
...
2. **Excel licenses are per-account / per-platform.** The maintainer
   team has Mac Excel 365 ja-JP. Practically and legally, we cannot run
   "all locales" on one machine.
