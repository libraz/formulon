...
/// crafted archive from forcing the central-directory walk to allocate
/// proportional memory before any extraction takes place.
inline constexpr std::size_t kMaxParts = 2048;
