...
double bessj0(double x) {
  ...
  const double y = z * z;
  const double p = 1.0 + y * (-0.1098628627e-2 +
                              y * (0.2734510407e-4 + y * (-0.2073370639e-5 + y * 0.2093887211e-6)));
  const double q = -0.1562499995e-1 +
                   y * (0.1430488765e-3 +
...
double bessy1(double x) {
  if (x < 8.0) {
    ...
    const double s = 0.2499580570e14 +
                     y * (0.4244419664e12 +
                          y * (0.3733650367e10 +
                               y * (0.2245904002e8 + y * (0.1020426050e6 + y * (0.3549632885e3 + y * 1.0)))));
