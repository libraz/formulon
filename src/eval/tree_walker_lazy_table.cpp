...
constexpr LazyEntry kLazyDispatch[] = {
    ...
    {"HLOOKUP", &eval_hlookup_lazy, LazyResultShape::kScalar},
    ...
    {"MATCH", &eval_match_lazy, LazyResultShape::kScalar},
    ...
    {"VLOOKUP", &eval_vlookup_lazy, LazyResultShape::kScalar},
    ...
    {"XMATCH", &eval_xmatch_lazy, LazyResultShape::kScalar},
