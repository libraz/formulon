...
Per-version release notes for Formulon are auto-generated on the GitHub
release page from the commit history; see the index below for direct links.
The high-level summary lives in [`CHANGELOG.md`](../../CHANGELOG.md).

## Available Versions

- [v0.9.6](https://github.com/libraz/formulon/releases/tag/v0.9.6) — Latest release (2026-07-19) — full Excel 365 dynamic-array spill semantics plus broad security / robustness hardening across evaluation and I/O.
